const drivingText = [
    {
        ...
        "3-11":"On a sunny day, you are driving on the left lane of a two-lane one-way pavement about 40km/h. The road is a uphill curves to the left. There is a box truck driving on your right about 60km/h. It drives past you and makes a sudden lane merge to your lane about 10 meters away. You have to brake immediately to avoid collision.",
...
const storyCollection = {
    ...
    "3-5":{
        'texts':[
            'On a sunny day, you are driving 30km/h through a one way road with two lanes. You notice that there is a road block 50 meters away on your lane; while on the opposite lane, you observe an incoming box truck 150 meters away traveling at a speed about 40km/h.',
    ...
    "3-14":{
        'texts':[
            ...
            "You decide to take the right exit and merge in the country road. You notice that the country road is also a one-way two-lane road, while the left lane is taken by a patio. You also notice that on your right, there is a line of three cyclists pedalling and enters the left-bending main road.",
    ...
    "3-16":{
        'texts':[
            ...
            "When you return to your lane, you notice that 40 meters ahead of your lane is blocked by some concrete wastes, at the same time, there are two trucks driving toward you at a speed of 30km/h in the opposite lane.",
            "You make an emergency stop 10 meters away from the waste to wait for the two trucks.",
            "After the two trucks passing by, you merge into the opposite lane to pass the concrete waste."
        ]
    },
    "3-17":{
        'texts':[
            "On a sunny day, you are driving 30km/h on the left lane of a one way road with two lanes. You notice that 100 meters away in the front, and another road merge from the left, but you cannot see the traffic in the merging road because of the line of trees.",
            "When you are about 20 meters from the merge-in intersection, a green SUV has appeared from the merging lane and have stopped half way cross your lane right front of you.",
    ...
    "3-18":{
        'texts':[
            "On a bright sunny day, you are driving on the left lane of a one way road with two lanes about 40km/h. On your right, there is a green SUV 20 meters ahead of you driving at the same speed.  You notice that in front of you on the right lane, there is a construction site blocking the road, so the SUV have to make a lane change to your lane to avoid collision.",
    ...
    "3-20":{
        'texts':[
            "On a bright sunny day, you are driving about 10km/h over a narrow bridge that is 20 meters above the water. You are driving close to the left side of the bridge to avoid a line of cyclists pedaling on your right. All cyclists are peddling at about 15km/h. ",
    ...
    "3-21":{
        'texts':[
            "On a bright sunny day, you are leaving a parking lot and are 30 meters away from merging in a one-way two-lane main road.",
            ...
            "After the trucks pass by, you merge into the main road."
        ]
    },
    "3-22":{
        'texts':[
...
const checkBoxs = {
    ...
    "3-17":{
        ...
        "env_dyn":["Required Lane Change Caused By Front Vehicle (Green SUV)","Front Vehicle (Green SUV) Speed","Front Vehicle (Green SUV) Behaviour", "Pedestrian"],
