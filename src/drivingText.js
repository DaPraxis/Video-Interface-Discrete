const drivingText = [
    {
        ...
        "3-16":"On a sunny day, you are driving 40km/h through a one-lane two-way concrete road. The road is bending right and slightly uphill. 30 meters away, there is a 50-meter long short tunnel. At the end of the tunnel, a yellow pickup vehicle occupies the lane. You merge to the opposite lane when you are about 15 meters away from the yellow vehicle to avoid collision. When you change to the opposite lane, you notice there is a incoming yellow pickup heading toward you on this lane only about 30 meters away at a speed of about 20km/h, so you accelerate to 70km/h to pass the construction vehicle and switch back to your lane immediately. When you back to your lane, you notice that 40 meters ahead of your lane is blocked by some concrete wastes, but on the opposite lane, there are a line of two incoming trucks driving at a speed of 30km/h. You make an emergent deceleration and stops 10 meters away from the waste to wait for the two trucks. After the two trucks passing by, you merge into the opposite lane to pass the concrete waste.",
        ...
        "3-18":"On a bright sunny day, you are driving on the left lane of a two-lane one-way concrete road about 40km/h. On your right, there is a green SUV 20 meters ahead of you driving in the same speed. You notice that 100 meters away on the right lane, there is a construction site blocks road, so the SUV have to make a lane change to your lane to avoid collision. When you are about 30 meters away from the construction site and only 10 meters away from the SUV, the SUV makes a sudden lane change to your lane. The road ahead bends almost 90 degree to the left after the SUV makes the lane change, so it decelerate to 30km/h to counter car drifting, and forces you to decelerate to keep your car under control.",
...
const checkBoxs = {
    "3-10":{
        "dv":["Driving Speed", "Driving Smoothness", "Distance to Incomming Vehicle", "Distance to Cyclists"],
        "env_dyn":["Cyclist Speed", "Incomming Vehicle Speed"],
    ...
    "3-12":{
        "dv":["Driving Speed", "Driving Smoothness", "Distance to Incomming Vehicle"],
        "env_dyn":["Incomming Vehicle Speed", "Incomming Vehicle Size","Incomming Vehicle Behaviour"],
        "env_static":["Road Type", "Road Width", "Road Curvature"]
        },
    "3-14":{
...
export {randomState, drivingText, checkBoxs}