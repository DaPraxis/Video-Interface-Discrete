...
const checkBoxs = {
    ...
    "3-16":{
        "dv":["Driving Speed", "Distance to Incoming Vehicle (Yellow Pickup)", "Distance to Incoming Vehicle (Box Trucks)", "Distance to Road Closure 1 (Yellow Pickup)", "Distance to Road Closure 2 (Concrete Wastes)",
