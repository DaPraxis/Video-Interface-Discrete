...
if (process.env.NODE_ENV === 'development') {
  ...
  mole_3 = require("../.." + "/assets/big_and_small/big_moley/bigmoley-3.png");
  ...
  mole_3 = "../.." + "/assets/big_and_small/big_moley/bigmoley-3.png";
 ...
 */
export default function AgainHardInstructions(props) {
  ...
  let automaticFlip = [4, 5, 7, 8];
  let afterFlip = [6, 9];

  let instructionsArray = t("games.TagMeAgainHard.ins").split("\n\n");
  let oneBefore = t("games.TagMeAgainHard.oneBefore");
  let twoBefore = t("games.TagMeAgainHard.twoBefore");
  let threeBefore = t("games.TagMeAgainHard.threeBefore");
  let fourBefore = t("games.TagMeAgainHard.fourBefore");

  // Function to automatically flip page
  let flipPage = () => {
    console.log("flip");
    setTimeout(function(){
  ...
  let pages = [
        ...
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeGrid}>
            <div className={classes.prevBoxPurple}>
              ...
              <img src={mole_3} className={classes.prevMole} alt="prevmole" />
              <img
                src={correct_circle}
          ...
          <div style={{marginLeft:"10%", marginTop: "min(15vh,120px)" }}>
    ...
    //p2: In Medium, you tagged a mole if it matched the Two Before!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.twoRows}>
            ...
            <div className={classes.beforeGrid} style={{ gridTemplateColumns: "36% 44%", position: "relative" }}>
              <div className={classes.doNotMatchLabel}>
                In this case, you don’t tag the mole, because it does not match to the TWO Before!
              </div>
              <div />
            </div>
          </div>
    ...
    // p3: In Hard, you need to remember numbers from Three Before!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeRightMiddleLeftGrid}>
            ...
            <Grid container direction="row" justify="center" alignItems="center">
              <Grid item xs={10}>
                <p className={classes.instructionsText}>
                  {instructionsArray[pageNum]} <span className={classes.instructionsGreen}>{threeBefore}</span>!
                </p>
              </Grid>
            </Grid>
            </div>
          </div>
          <div style={{marginLeft:"20%", marginTop: "min(19vh,130px)" }}>
            <Grid item container direction="row" justify="center" alignItems="center">
              <Grid
                item
                container
    ...
    //p4: Tag the next mole if it matches the mole three before!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeRightMiddleLeftGrid}>
    ...
    //p5: Does this mole match the mole three before?
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeRightMiddleLeftGrid}>
    ...
    //p6: Yes, the three before wore a “3”, so tag it!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.twoRows}>
            <div className={classes.beforeRightMiddleLeftGrid} style={{ position: "relative" }}>
              <div className={classes.prevBoxGreen}>
                <p className={classes.trialLabel}>Trial 1</p>
                <img src={mole_3} className={classes.prevMole} alt="prevmole" />
                <img
    ...
    //p7: Don’t tag the next mole if it doesn’t  match the mole three before!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeFourRectGrid}>
            <div className={classes.prevBoxPurple}>
              <p className={classes.trialLabel}>Trial 1</p>
              <img src={mole_3} className={classes.prevMole} alt="prevmole" />
              <br />
            ...
            <div className={classes.prevBoxPurple}>
              <p className={classes.trialLabel}>Trial 4</p>
              <img src={mole_3} className={classes.prevMole} alt="prevmole" />
              <br />
              <p>{oneBefore}</p>
            </div>
    ...
    //p8: Does this mole match the mole three before?
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeFourRectGrid}>
    ...
    //p9: No, the three before wore a “3”, so don’t tag it!
    <div className={classes.whiteBg}>
      <div className={classes.padding}>
        <div style={{ width: "100%", margin: "auto" }}>
          <div className={classes.beforeFourRectGrid}>
