...
if (process.env.NODE_ENV === 'development') {
  ...
  all = require(process.env.REACT_APP_MY_URL + "/assets/mood/all.png");
}else{
  ...
  all = process.env.REACT_APP_MY_URL + "/assets/mood/all.png";
}
...
export default function TuneInstructions(props) {
  ...
  let pages = [
    <>
      ...
      In this game, all you need to do is tag each face as quickly and accurately as possible. There are no wrong faces.
      <br/>
