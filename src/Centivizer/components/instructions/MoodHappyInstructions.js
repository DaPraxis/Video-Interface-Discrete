...
if (true) {
  ...
  happy = require(process.env.REACT_APP_MY_URL + "/assets/mood/happy.png");
}else{
  ...
  happy = process.env.REACT_APP_MY_URL + "/assets/mood/happy.png";
}
...
export default function TuneInstructions(props) {
  ...
  let pages = [
    <>
      ...
      In this game, tag each HAPPY face as quickly and accurately as possible. Do not tag the fearful and neutral faces.
      <br/>
      Remember: The faster you tag the happy face, the better your score!
      </p>
      <Grid
        container
        spacing={0}
