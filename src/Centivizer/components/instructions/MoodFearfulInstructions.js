...
if (true) {
  ...
  fearful = require(process.env.REACT_APP_MY_URL + "/assets/mood/fearful.png");
}else{
  ...
  fearful = process.env.REACT_APP_MY_URL + "/assets/mood/fearful.png";
}
...
export default function TuneInstructions(props) {
  ...
  let pages = [
    <>
      ...
      In this game, tag each FEARFUL face as quickly and accurately as possible. Do not tag the happy and neutral faces.
      <br/>
      Remember: The faster you tag the fearful face, the better your score!
      </p>
      <Grid
        container
        spacing={0}
