...
if (process.env.NODE_ENV === 'development') {
  ...
  holes_top = require(process.env.REACT_APP_MY_URL + "/assets/mood/holes_top.png");
  holes_bottom = require(process.env.REACT_APP_MY_URL + "/assets/mood/holes_bottom.png");
  ...
  holes_top = process.env.REACT_APP_MY_URL + "/assets/mood/holes_top.png";
  holes_bottom = process.env.REACT_APP_MY_URL + "/assets/mood/holes_bottom.png";
